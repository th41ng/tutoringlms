...
//    public ResponseEntity<MultipleChoiceAssignmentDTO> getMultipleChoiceAssignmentById(@PathVariable Long assignmentId) {
//        Optional<Assignment> optionalAssignment = essayAssignService.getAssignmentById(assignmentId);
//
...
//
//        // Chuyển sang DTO
//        MultipleChoiceAssignmentDTO dto = MultipleChoiceAssignmentMapper.toDTO(assignment);
//
//        return ResponseEntity.ok(dto);
//    }
